	  ...
	  <h3>About Us</h3>
	   ...
	   <div class="container">		  
		 <div class="col-md-4 about-grids">
			 <h4 text-center>Our Vision</h4>
			 <p> At GoWentGone, our vision is to become the preferred choice for travelers seeking unforgettable experiences around the globe. We aim to inspire and empower individuals to explore the world, discover new cultures, and create lasting memories. Through our dedication to exceptional service, innovation, and sustainability, we strive to exceed the expectations of our customers and set new standards in the travel industry.</p>
		 </div>
		 <div class="col-md-4 about-grids ">
			 <h4>Our Mission</h4>
			 <p>Our mission at GoWentGone is to provide personalized and memorable travel experiences that cater to the unique preferences and needs of each traveler. We are committed to offering a wide range of destinations, flexible itineraries, and top-notch customer service to ensure that every journey with us is seamless and enjoyable. By fostering meaningful connections with our customers, partners, and communities, we aim to enrich lives and create positive impacts through travel.</p>
		 </div>
		 <div class="col-md-4 about-grids">
			 <h4>Safety Information</h4>
			 <p>At GoWentGone, your safety and well-being are our top priorities. We understand the importance of feeling secure and comfortable while traveling, which is why we take every precaution to ensure a safe and worry-free experience for our customers. From carefully vetting our partners and suppliers to providing comprehensive travel insurance options, we are dedicated to maintaining the highest standards of safety and security at all times. Additionally, we continuously monitor global travel advisories and updates to keep our customers informed and prepared for any unforeseen circumstances. Your safety is our commitment, and we are here to support you every step of the way.</p>
		 </div>
	 </div>
</div>
<!--/About-->
